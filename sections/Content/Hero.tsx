...
export default function HeroFlats({
  ...
  return (
    <section class="flex h-[calc(100vh-95px)] lg:h-[calc(100vh-80.25px)] justify-center items-center bg-black dark:bg-b-300">
      <div class="flex flex-col lg:flex-row items-center justify-center mx-auto h-full w-full lg:max-w-[1224px] min-[1650px]:max-w-[1440px] gap-6 lg:gap-12 px-6 pb-10 lg:px-16 lg:pb-0">
