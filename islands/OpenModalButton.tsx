            ...
            {displayContactModal.value && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 overflow-y-auto">
                    <div className="bg-black p-8 rounded-lg w-full max-w-xl relative overflow-y-auto max-h-screen">
                        <button className="absolute top-4 right-4" onClick={() => { displayContactModal.value = false }}>
                            <Icon id="closeModal" class="text-main" size={32} strokeWidth={0.01} />
                        </button>
                        ...
                        <form onSubmit={handleSubmit} class="text-white">
                            ...
                            >
                                <p className="text-nowrap text-sm lg:text-[1rem]">ENVIAR RESPOSTAS</p>
                                <Icon id="ExternalLink" class="text-black" size={20} strokeWidth={0.01} />
                            </button>
                        </form>
                    </div>
                </div>
