        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 overflow-y-auto">
          <div className="bg-black p-8 rounded-lg w-full max-w-xl relative overflow-y-auto max-h-screen">
            ...
            <form onSubmit={handleSubmit} class="text-white">
              ...
              <div className="flex flex-col mb-8">
                <label class="font-medium">Para você, o treinamento ideal resolveria o quê?</label>
                <textarea
              ...
              <div className="flex flex-col mb-8 relative">
                ...
                <select
                  ...
                  required
                >
                  <option class="bg-black text-white">Módulo I</option>
                  <option class="bg-black text-white">Módulo II</option>
                  {/* Add other options as needed */}
                </select>
                <div className="absolute right-6 top-2/3 transform -translate-y-1/2 pointer-events-none">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 32 32" fill="none">
              ...
              <div className="flex flex-col mb-8 relative">
                <label class="font-medium">Data que deseja realizar o treinamento</label>
                <input
                  type="date"
                  className="w-full px-6 py-3 border border-b-200 rounded-full bg-transparent mt-2 placeholder-opacity-50"
                  required
                ...
                <div className="absolute right-6 top-2/3 transform -translate-y-1/2 pointer-events-none">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 32 32" fill="none">
                    <path opacity="0.2" d="M27 6V11H5V6C5 5.73478 5.10536 5.48043 5.29289 5.29289C5.48043 5.10536 5.73478 5 6 5H26C26.2652 5 26.5196 5.10536 26.7071 5.29289C26.8946 5.48043 27 5.73478 27 6Z" fill="#FFBC4E"/>
                    <path d="M26 4H23V3C23 2.73478 22.8946 2.48043 22.7071 2.29289C22.5196 2.10536 22.2652 2 22 2C21.7348 2 21.4804 2.10536 21.2929 2.29289C21.1054 2.48043 21 2.73478 21 3V4H11V3C11 2.73478 10.8946 2.48043 10.7071 2.29289C10.5196 2.10536 10.2652 2 10 2C9.73478 2 9.48043 2.10536 9.29289 2.29289C9.10536 2.48043 9 2.73478 9 3V4H6C5.46957 4 4.96086 4.21071 4.58579 4.58579C4.21071 4.96086 4 5.46957 4 6V26C4 26.5304 4.21071 27.0391 4.58579 27.4142C4.96086 27.7893 5.46957 28 6 28H26C26.5304 28 27.0391 27.7893 27.4142 27.4142C27.7893 27.0391 28 26.5304 28 26V6C28 5.46957 27.7893 4.96086 27.4142 4.58579C27.0391 4.21071 26.5304 4 26 4ZM9 6V7C9 7.26522 9.10536 7.51957 9.29289 7.70711C9.48043 7.89464 9.73478 8 10 8C10.2652 8 10.5196 7.89464 10.7071 7.70711C10.8946 7.51957 11 7.26522 11 7V6H21V7C21 7.26522 21.1054 7.51957 21.2929 7.70711C21.4804 7.89464 21.7348 8 22 8C22.2652 8 22.5196 7.89464 22.7071 7.70711C22.8946 7.51957 23 7.26522 23 7V6H26V10H6V6H9ZM26 26H6V12H26V26Z" fill="#FFBC4E"/>
                  </svg>
                </div>
              </div>
              <div className="flex justify-center">
                <button
                  type="submit"
                  className="px-8 py-4 bg-main text-black rounded-full hover:bg-opacity-75 transition-opacity duration-300"
                >
                  Enviar
                </button>
              </div>
